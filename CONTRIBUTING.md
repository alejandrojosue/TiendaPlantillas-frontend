...
## Bienvenido a 'Plataforma de Contratación Freelance y Venta de Plantillas' 🌟

¡Estamos emocionados de que quieras contribuir a nuestro proyecto! Este documento te guiará a través de los pasos necesarios para hacer tu aporte al proyecto, que incluye tanto el backend como el frontend. Queremos que este proceso sea lo más sencillo y transparente posible, así que aquí tienes una guía paso a paso.

### Primeros pasos 🚀

1. **Familiarízate con las tecnologías utilizadas**: Si aún no lo has hecho, asegúrate de entender cómo funcionan Strapi, HTML5, CSS3, Tailwind CSS y Preact JS. Puedes encontrar información útil en sus respectivas documentaciones.

2. **Configura tu entorno de desarrollo**: Asegúrate de tener las herramientas necesarias instaladas, como Node.js y pnpm para gestionar las dependencias del proyecto.
...
- **Sincroniza el fork**: Puedes hacerlo desde `github.com/tu-usuario/tu-repositorio-de-la-velada` y haciendo clic en `Sync fork`. También puedes hacerlo desde la terminal `gh repo sync -b main` o `git switch main && git fetch upstream && git merge upstream/main`. Más información en la [documentación oficial de Github](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/syncing-a-fork)
...
- **Crea un Pull Request (PR)**: En GitHub, ve a tu fork de 'Plataforma de Contratación Freelance y Venta de Plantillas' y haz clic en "Pull request" para iniciar uno. Asegúrate de describir claramente qué cambios has realizado y por qué son necesarios o útiles para el proyecto.
...
¡Gracias por contribuir a 'Plataforma de Contratación Freelance y Venta de Plantillas'! Juntos estamos construyendo algo increíble. 🚀